...
int main() {
    // Робота з двовимірним масивом розміром 4x5
    ...
    std::cout << "Суми від'ємних елементів кожного рядка першого масиву:" << std::endl;
    for(int i = 0; i < 4; i++) {
        std::cout << "Рядок " << (i + 1) << ": " << sumNegative[i] << std::endl;
    }

    // Робота з двовимірним масивом розміром 5x4
    ...
    std::cout << "\nМаксимальні елементи кожного рядка другого масиву: " << std::endl;
    for(int i = 0; i < 5; i++) {
